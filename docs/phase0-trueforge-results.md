...
| Sandbox isolation and network measurement | `PASS` | Sandbox Python reported the exact checkout and private-runtime boundary sentinels inaccessible, and an observed outbound network attempt blocked. Only boolean measurements were retained. |
